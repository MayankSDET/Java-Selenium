...
public class windowHandles {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//System.setProperty("webdriver.chrome.driver", "C:\\Users\\Mayank Shrivastav\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
		...
		WebElement button = wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(By.id("submitButton"))));
		button.click();
	} 
}